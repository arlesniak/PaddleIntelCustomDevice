...
#     def test_check_output(self):
#         place = core.CustomPlace('custom_intel', 0)
    ...
    def test_errors(self):
        with program_guard(Program(), Program()):
            ...
            x1 = fluid.create_lod_tensor(
                np.array([[-1]]), [[1]], fluid.CustomPlace('custom_intel', 0))
...
class API_TestSumOp(unittest.TestCase):
    def run_static(self,
        ...
        places = [fluid.CustomPlace('custom_intel', 0)]
        for place in places:
    ...
    def test_dygraph(self):
        ...
        with fluid.dygraph.guard(paddle.CustomPlace('custom_intel', 0)):
...
class TestAllAPI(unittest.TestCase):
    def setUp(self):
        ...
        self.places = [fluid.CustomPlace('custom_intel', 0)]
        if core.is_compiled_with_cuda():
            self.places.append(fluid.CustomPlace('custom_intel', 0))
